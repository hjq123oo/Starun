...
public class RunPlanSharedPreferences {
     ...
     */
    public void setPlanSchedule(int runPlanId,int lessonIndex,float planPercentage){
     ...
     * @return Map<String,Object>对象：runPlanId-runPlanId,<String,Integer>,计划进度id;lessonIndex-lessonIndex,<String,Integer>,第几课;planPercentage-planPercentage,<String,Float>，计划进度百分比;
     */
